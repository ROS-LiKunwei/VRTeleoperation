...
KEYPOINT_TRANSFORM_PORT = 8092  # 右手关键点变换端口
LEFT_KEYPOINT_TRANSFORM_PORT = 8093  # 左手关键点变换端口

# Camera / image streaming ports
CAM_PORT_OFFSET = 10005
SIM_IMAGE_PORT = 10005
CAMERA_PROJECTION_CONTROL_PORT = 10006
...
# SYSMO-32 真实接口镜像端口
# 这些是真实的ROS2命令主题的内部BeaVR ZMQ镜像，因此模拟运行和MuJoCo验证可以使用完全相同的18字段命令载荷
SYSMO32_ARM_COMMAND_MIRROR_PORT = 12040  # 内部发布 18 维 Sysmo32ArmCommand，用于simulation
SYSMO32_HAND_ACTION_MIRROR_PORT = 12041  # 内部发布左右手固定动作，用于simulation
